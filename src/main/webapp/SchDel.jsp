	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<%
			while (rs.next()) {
				...
				String deltext = rs.getString("text");
		%>
				<tr>
					<td>
						<%=
					...
					<td>
						<a href="<%=request.getContextPath()%>/schdel.do?Removeid=<%=delid%>&Removetext=<%=deltext %>"><span class="label label-danger">删除</span></a>
					</td>
				</tr>
		<%
			}
