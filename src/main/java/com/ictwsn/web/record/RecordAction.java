...
//对应SchServlet及SchdelServlet

@Controller
@RequestMapping("/web/record")
public class RecordAction {

    public static Logger logger = LoggerFactory.getLogger(RecordAction.class);

    @RequestMapping("/audiodel.do")
    public String AudiodelServlet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException
    {
//驱动程序名
