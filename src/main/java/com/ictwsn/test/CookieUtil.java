...
public class CookieUtil {
	...
	private static String cookieDomainName = "ysukeg";
	// 加密cookie时的网站自定码
	private final static String webKey = "ysukeg";
	...
	public static void saveCookie(UserBean userBean,
		...
		// MD5加密用户详细信息
		String cookieValueWithMd5 = getMD5(userBean.getUsername() + ":"
				+ userBean.getPassword() + ":" + validTime + ":" + webKey);
		// 将要被保存的完整的Cookie值
		String cookieValue = userBean.getUsername() + ":" + validTime + ":"
				+ cookieValueWithMd5;
		...
		logger.info("已存储用户Cookie：{}", userBean.getUsername());
	}
	...
	public static int readCookieAndLogon(HttpServletRequest request,
		...
		if (userBean.getUsername()!= null
			...
			String md5ValueFromUser = getMD5(userBean.getUsername() + ":"
					+ userBean.getPassword() + ":" + validTimeInCookie
					+ ":" + webKey);
